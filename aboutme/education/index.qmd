...
description: "cool classes I took"
...
3.  **Freshwater Ecology: Sensors to Satellites**
...
4.  **Soils Science**
    -   I studied the physical and chemical properties of soils, with coursework covering soil physics, hydrology, classification and identification, soil biology, formation and weathering processes, and how agricultural practices influence soil health
...
6.  **Intro to Modern Logic**
    -   A foundational course in analytical reasoning and formal logic. Coursework included argument structure, symbolic representation, validity, and proof techniques. Breaking down arguments into core building blocks helped strengthen my technical writing.
    
    
7.  **Fluvial Geomorphology**
    -   Technical topics covered sediment deposition, stream order classification, water infrastructure including dams, levees, and embankments. Labs included hydrologic flow modeling, QGIS watershed delineation, and a cartography workshop. My favorite aspect of this class was the field work in Mission Creek, where we conducted pebble counts, measured stream flow, and analyzed the urban channelization and its role in flood control.
    
    
8.  **GIS For Environmental Applications**
    -   A foundational spatial analysis course covering cartography, projections, vector and raster data, geoprocessing tools, and map design. I used ArcGIS Pro to build maps, analyze spatial patterns, and solve environmental problems using geospatial data.
...
10. **Religion in the Environment**
    -   Learning about the role religion played in supporting and resisting the displacement of millions of people during peak dam construction in post-colonial India motivated me to narrow my focus from Environmental Studies to Hydrologic Science and Policy.
